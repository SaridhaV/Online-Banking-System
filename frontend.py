...
from backend import authenticate, transfer_funds
...
class BankingApp(QWidget):
    ...
    def login(self):
        ...
        user_account = authenticate(account_num, pin)
        if user_account:
    ...
    def transfer(self):
        ...
        amount = int(self.input_amount.text())
        if transfer_funds(self.user_account.account_num, recipient_account_num, amount):
